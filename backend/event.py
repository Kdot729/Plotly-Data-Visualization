...
def sort_new_DataFrame(dictionary, DataFrame, column_dictionary):
    ...
    if (dictionary["ID of Dropdown"] == "Start-Date") or (dictionary["ID of Dropdown"] == "End-Date") or ((dictionary["ID of Dropdown"] == "Address") and not (dictionary["Chosen Addresses"])):
